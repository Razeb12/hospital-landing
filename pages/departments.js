    ...
    <main>
      ...
      <section className="relative bg-sky-800 pb-24 pt-32 mt-20 sm:pb-32">
        <div className="absolute inset-0">
          ...
          />
          <div
            className="absolute inset-0 bg-gradient-to-l from-sky-800 to-cyan-800 mix-blend-multiply"
            aria-hidden="true"
          />
        </div>
        <div className="relative mx-auto mt-24 max-w-md px-4 sm:mt-32 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-xl text-white">
            ...
            form below or visit our medical center personally. We would be happy
          ...
          <ul className="shadow-md rounded-md p-6 border w-full xl:w-3/4 border-gray-200 flex flex-col space-y-2 h-fit">
            {departments.map((department, index) =>
              <li
                ...
                key={index}
                className={
                  "flex items-center justify-between capitalize py-4 cursor-pointer pl-2 hover:bg-cyan-700 hover:text-white transition-all duration-300 ease-in-out " +
                  (tab === index + 1
                    ? "border-cyan-700 border-l-4 hover:bg-transparent hover:text-black"
                    : "")
                }>
                {department}
              </li>
              ...
              <div className="flex flex-col space-y-4">
                <div className="flex flex-col space-y-2">
                  ...
                  <p className="text-gray-500">
                    ...
                    Eligendi corrupti esse velit dolores provident illo voluptas
                    at, sapiente autem perspiciatis illum impedit tempora
                    ratione modi hic. Eligendi corrupti esse velit dolores
                    provident illo voluptas at, sapiente autem perspiciatis
                    illum impedit tempora ratione modi hic. Eligendi corrupti
                    esse velit dolores provident illo voluptas at, sapiente
                    autem perspiciatis illum impedit tempora ratione modi hic.
