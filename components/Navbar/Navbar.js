...
export default function Navbar() {
  return <Popover className="sticky top-0 bg-white z-50 ">
    <div className="mx-auto max-w-7xl px-4 sm:px-6">
      <div className="flex items-center justify-between  py-3 md:justify-start md:space-x-10">
        ...
        <Popover.Group as="nav" className="hidden space-x-10 md:flex">
          ...
          <Link href={"/"}>
            <span className="text-base  cursor-pointer font-medium text-gray-500 hover:text-gray-900">
              Home
            </span>
          </Link>
          <a href="#" className="text-base  cursor-pointer font-medium text-gray-500 hover:text-gray-900">
            About
          </a>
          <a href="#" className="text-base  cursor-pointer font-medium text-gray-500 hover:text-gray-900">
            Services
          </a>
          <Link href="/department" className="text-base  cursor-pointer font-medium text-gray-500 hover:text-gray-900">
            Departments
          </Link>
          {/* <a href="#" className="text-base  cursor-pointer font-medium text-gray-500 hover:text-gray-900">
              blog
        ...
        <div className="hidden  items-center justify-end md:flex md:flex-1 lg:w-0">
          <button className="inline-block rounded-xl bg-cyan-500 px-4 py-1.5 text-base font-semibold leading-7 text-white hover:text-white shadow-sm ring-1  hover:bg-cyan-500">
            Make An Appointment
          </button>
        </div>
      </div>
          ...
          <div className="space-y-6 py-6 px-5">
            ...
            <div>
              ...
              <p className="mt-6 text-center text-base font-medium text-gray-500">
                Existing customer? <a href="#" className="text-indigo-600 hover:text-indigo-500">
                  Sign in
                </a>
              </p>
            </div>
